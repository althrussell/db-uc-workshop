...
-- MAGIC To run this demo, just select the cluster `dbdemos-delta-sharing-airlines-james_mcniff` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/1128-022846-2u0gvvde/configuration)). <br />
...
-- MAGIC
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fgovernance%2Fdelta-sharing-airlines%2F04-share-data-within-databricks&cid=984752964297111&uid=6480688324232166">
