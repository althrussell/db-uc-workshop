...
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-04-system-tables-james_mcniff` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/1128-233130-ou52mqvo/configuration)). <br />
...
-- MAGIC %md 
-- MAGIC *Looking for the notebook used to create the [forecasting dashboard](/sql/dashboards/3c9c0537-dac7-49e1-abc4-c9a5a169447b)? Jump to the [02-forecast-billing-tables]($./02-forecast-billing-tables) notebook.*
