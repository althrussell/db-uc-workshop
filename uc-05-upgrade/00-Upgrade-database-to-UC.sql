...
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-05-upgrade-al_thrussell` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/1019-065054-wz0zcuk9/configuration)). <br />
