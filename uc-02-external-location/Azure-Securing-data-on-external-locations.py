...
# MAGIC To run this demo, just select the cluster `dbdemos-uc-02-external-location-al_thrussell` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/1019-224701-v8r2flkz/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fgovernance%2Fuc-02-external-location%2FAzure-Securing-data-on-external-locations&cid=1444828305810485&uid=8264923750561714">
