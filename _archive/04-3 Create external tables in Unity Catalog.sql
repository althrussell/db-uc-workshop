...
-- MAGIC %run ./Includes/04-3-Classroom-Setup
...
-- MAGIC %python
-- MAGIC print(f"SELECT * FROM {DA.catalog}.{DA.db_name}.silver_external")
...
-- SHOW CREATE TABLE silver_external

-- COMMAND ----------

-- MAGIC %md
-- MAGIC Now let's drop both tables. Uncomment and run the following two cells.
...
-- MAGIC %md
-- MAGIC Let's repeat these steps for to recreate and display the **silver_external** table.

-- COMMAND ----------

-- paste createtab_stmt for silver_external from above
